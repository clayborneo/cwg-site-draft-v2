...
<div id="color-switch" aria-label="Color variation">
  ...
  <a class="sw-back" href="brand-review.html">&larr; Back to the logo review</a>
</div>
<style>
  ...
  #color-switch .sw-back { display: block; margin-top: 10px; padding: 8px 10px; border-radius: 8px; background: #5E2D5E; color: #fff; text-align: center; font-size: .8rem; font-weight: 600; text-decoration: none; }
  #color-switch .sw-back:hover { background: #43203F; }
